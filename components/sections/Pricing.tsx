...
export default function Pricing() {
  return (
    <section id="pricing" className="relative overflow-hidden py-28">
      ...
      <div className="absolute top-0 left-1/2 h-[800px] w-[800px] -translate-x-1/2 rounded-full bg-gradient-to-b from-jade/10 to-transparent blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <FadeIn delay={0.2}>
          ...
          >
            <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-jade via-cyan to-jade blur opacity-20" />

            <div className="relative rounded-3xl border border-white/[0.15] glass-card p-8 sm:p-12">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full border border-white/15 bg-white/[0.08] transition-colors hover:bg-white/[0.12] px-6 py-2">
              ...
              <div className="grid gap-10 pt-4 lg:grid-cols-[0.86fr_1.14fr] lg:items-start">
                <div>
                  ...
                  <p className="mt-3 text-jade-light">
                  ...
                  <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
                    <a
                      href="/preorder"
                      className="block rounded-xl border border-white/15 bg-white/[0.08] transition-colors hover:bg-white/[0.12] px-6 py-4 text-center text-lg font-semibold text-white transition-shadow hover:shadow-lg hover:shadow-jade/20"
                    >
                      Pre-Order
                    </a>
                    ...
                    <a
                      href="/login"
                      className="block rounded-xl border border-white/[0.15] bg-white/[0.08] px-6 py-4 text-center font-medium text-cyan transition-colors hover:border-cyan/50 hover:bg-cyan/15"
                    >
                      Join Program
                    </a>
                    ...
                    <a
                      ...
                      className="block rounded-xl border border-white/[0.1] px-6 py-4 text-center font-medium text-white/78 transition-colors hover:border-cyan/40 hover:text-cyan"
                    >
                      View Program
                    </a>
                  </div>
                ...
                <div>
                  ...
                  <div className="mt-6 grid gap-3.5 md:grid-cols-2">
                    {features.map((feature) => (
                      <div
                        key={feature.title}
                        className="flex min-h-[112px] items-start gap-3 rounded-2xl border border-white/[0.1] bg-white/[0.06] px-4 py-4 sm:px-5"
                      >
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-6 border-t border-white/[0.1] pt-6">
