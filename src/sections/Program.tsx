...
export const Program = () => {
  return (
    <section id="program" className="relative overflow-hidden bg-navy-900 px-4 py-16 sm:px-6 md:py-24">
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        <FadeIn className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-bold text-white sm:text-5xl lg:text-6xl tracking-tight">Start with the current cohort</h2>
